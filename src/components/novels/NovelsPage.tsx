...
const NovelsPage = () => {
    ...
    return (
        <div className="min-h-screen text-gray-100">
            {/* Header */}
            <div className="bg-gradient-to-br from-gray-950 via-gray-900 to-gray-800 border border-gray-600 rounded-xl mb-8">
                        ...
                        <div className="mt-4 pt-4 border-t border-gray-700">
                            <div className="flex items-center gap-2 flex-wrap">
                                ...
                                {selectedGenres.map(genreId => {
                                    const genre = genres.find((g: Genre) => g._id === genreId);
                                    return genre ? (
                                        <span
                                            key={genreId}
                                        ...
                                        >
                                            ...
                                            <div className={
                                                ...
                                                <Image
                                                    ...
                                                    className={`object-cover object-top transition-transform duration-300 group-hover:scale-110 ${viewMode === 'list' ? 'rounded-xl h-full' : 'rounded-t-2xl w-full h-80'
                                                        }`}
                                                />
                                                {viewMode === 'grid' && (
                                                    <>
