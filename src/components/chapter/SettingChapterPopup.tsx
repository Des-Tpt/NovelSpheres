                        ...
                        <div className="space-y-6">
                            ...
                            >
                                <label className={`block text-sm font-medium mb-3 ${
                                    nightMode === 'dark' ? 'text-gray-300' : 'text-gray-700'
                                }`}>
                                    Kích thước chữ
                                </label>
                                <div className="flex items-center gap-4">
                                    ...
                                    />
                                    <div className={`w-16 text-right text-sm font-medium px-2 py-1 rounded ${
                                        nightMode === 'dark' 
                                            ? 'text-white bg-black' 
                            ...
                            >
                                ...
                                <select
                                    ...
                                    className={`w-full px-3 py-2 border-2 border-blue-500 rounded focus:outline-none focus:border-blue-400 transition-colors ${
                                        nightMode === 'dark' 
                                            ? 'bg-black text-white' 
                            ...
                            <motion.div
                                ...
                                className={`border rounded-lg p-4 ${
                                    nightMode === 'dark' ? 'border-gray-600' : 'border-gray-300'
                                }`}
                            >
                                ...
                                <div
                                    className={`p-4 rounded border max-h-32 overflow-auto ${
                                        localNightMode === 'dark' 
                            ...
                            >
                                ...
                                <div className="flex gap-3 sm:ml-auto">
                                    <motion.button
                                        ...
                                        whileTap={{ scale: 0.98 }}
                                        onClick={onClose}
                                        className={`flex-1 sm:flex-none px-4 py-2 border rounded transition-colors ${
                                            nightMode === 'dark' 
