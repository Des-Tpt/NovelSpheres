...
const Banner = () => {
    return (
        <div className="flex flex-col items-center text-center bg-black pb-20 px-2.5 md:bg-gradient-to-r md:from-black md:from-20% md:via-gray-950 md:via-75% md:to-black">
            <motion.div
            ...
            >
                <div className="rounded-[5rem] p-2.5 bg-amber-800">
                    <div className="rounded-[3rem] p-1 bg-gray-900">
                        <Library className="w-20 h-20 px-3 text-yellow-500" />
                    </div>
                </div>
                <h1 className="text-5xl md:text-6xl px-3.5 font-bold">Chào mừng đến với <span className="text-yellow-500">NovelSphere</span></h1>
